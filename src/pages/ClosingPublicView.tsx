            ...
            <div className="bg-gray-50 rounded-2xl p-4 sm:p-6 mb-8 border border-gray-200">
              ...
              <div className="mt-4">
                ...
                <div className="bg-white rounded-xl border border-gray-200 shadow-inner relative w-full overflow-hidden">
                  ...
                  <div className="text-sm text-gray-700 leading-relaxed text-justify max-h-[500px] overflow-y-auto overflow-x-hidden break-words custom-scrollbar p-4 sm:p-6 pt-5 pb-10 prose max-w-none prose-sm prose-p:my-2 prose-headings:my-4 w-full">
