    ...
    <Layout>
      <div className="max-w-6xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {/* STARTER */}
          <div className="bg-white border-2 border-gray-100 rounded-3xl p-8 shadow-lg hover:shadow-xl transition-shadow flex flex-col relative">
            ...
            <button 
              ...
              disabled={loading}
              className="w-full py-4 bg-gray-900 text-white font-black rounded-2xl shadow-lg hover:bg-black transition-all flex items-center justify-center gap-2"
            >
          ...
          {/* PLUS */}
          <div className="bg-gradient-to-b from-orange-50 to-white border-2 border-orange-400 rounded-3xl p-8 shadow-2xl relative overflow-hidden flex flex-col transform md:-translate-y-4">
