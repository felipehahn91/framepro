...
export default function ContractPublicView() {
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      await doc.html(contractRef.current, {
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 font-sans text-gray-900">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
          <div ref={contractRef} className="p-10 bg-white text-black" style={{ width: '190mm', backgroundColor: '#ffffff' }}>
            ...
            <div className="prose max-w-none mb-16 text-black text-justify leading-relaxed" dangerouslySetInnerHTML={{ __html: contract.description }} />
            
            <div className="mt-16 pt-8 border-t border-gray-200 grid grid-cols-2 gap-12">
              <div className="flex flex-col items-center">
                <div className="h-24 w-full flex flex-col justify-end border-b border-gray-800 relative mb-2">
                  {isSigned ? (
                    <img src={contract.client_signature} crossOrigin="anonymous" alt="Assinatura" className="max-h-20 mx-auto" />
                  ) : (
                ...
                <p className="text-[10px] text-gray-500 uppercase tracking-widest mt-1">Contratante</p>
                {!isSigned && (
              ...
              <div className="flex flex-col items-center text-center">
                <div className="h-24 w-full flex flex-col justify-end border-b border-gray-800 relative mb-2">
                  {contract.supplier_signature ? (
                    <img src={contract.supplier_signature} crossOrigin="anonymous" className="max-h-20 mx-auto" />
                  ) : (
                    <div className="text-gray-300 text-[10px] mb-4">Pendente assinatura</div>
                  )}
                </div>
                <p className="font-bold text-sm text-black">Fornecedor</p>
